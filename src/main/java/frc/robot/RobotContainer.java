  ...
  public RobotContainer() {
    ...
    try {
      SOTA_MotorController rotationMotor = MotorControllerFactory.generateMotorController(
        ...
        SOTA_AbsoulteEncoder rotatiEncoder = EncoderFactory.generateAbsoluteEncoder(configUtils.readFromClassPath(EncoderConfig.class, "SuperStructure/RotationEncoder"));
        ...
        // SOTA_MotorController intakeMotorTop = MotorControllerFactory.generateMotorController
        // (configUtils.readFromClassPath(MotorControllerConfig.class, "SuperStructure/IntakeMotorTop"));
        // SOTA_MotorController intakeMotorBottom = MotorControllerFactory.generateMotorController
