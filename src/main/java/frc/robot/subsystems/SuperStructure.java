...
public class SuperStructure extends SubsystemBase {
  ...
  public SuperStructure(DoubleSupplier extensionLength, DoubleSupplier CurrentAngle, SuperStructureConfig config) {
    ...
    this.bOffset = config.getBackOffset(); 
    this.fOffset = config.getFrontOffset(); 
    this.armLength = config.getArmBaseLength();
    this.fAbsoluteOffset = config.getFrontAbsoluteOffset(); 
    this.bAbsoluteOffset = config.getBackAbsoluteOffset();
